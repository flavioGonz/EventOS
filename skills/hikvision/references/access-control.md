...
> Taxonomía COMPLETA (mayor/menor + hex + linkage): `isapi/.../Access Control Event
> Types and Event Linkage Types.pdf`. Los endpoints de control de acceso *por personas*
> todavía no están en el catálogo — ver `pending-sources.md`.
