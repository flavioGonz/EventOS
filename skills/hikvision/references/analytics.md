...
> Diccionario COMPLETO ya extraído: `assets/field-enums.json` (171 campos, 1.954
> valores), o `python3 isapi/tools/hik.py field <campo>`. Fuente: `Field Dictionary.xlsx`.
> Los schemas de `/ISAPI/Smart/*` con todos sus campos están en `isapi/openapi/`
> (`hik.py schema LineDetection`).