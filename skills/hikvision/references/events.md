...
> **Nota de catálogo:** `alertStream` y `subscribeEvent` figuran hoy como
> `tier: narrative` — los 5 manuales que tenemos los mencionan en el capítulo
> Quick Start pero no los documentan formalmente, así que no tienen schema.
> El manual que los documenta (*API - Análisis Inteligente y Eventos*) está
> pendiente; ver `pending-sources.md`. Lo de acá está verificado en campo.
