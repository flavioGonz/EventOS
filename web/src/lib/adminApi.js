...
export const EVENT_CATALOG = {
  ...
  abandoned_object:{ category: 'intrusion', title: 'Objeto abandonado' },
  object_removal:  { category: 'intrusion', title: 'Objeto retirado' },
  loitering:       { category: 'intrusion', title: 'Merodeo' },
