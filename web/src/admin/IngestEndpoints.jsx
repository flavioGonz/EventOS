// Endpoints de ingesta — cómo cada dispositivo envía sus eventos a EventOS:
// token de ingesta + URL EXACTA (lista para pegar) por dispositivo + guías por tipo.
// Vive dentro de Configuración (antes estaba en Recepción).
...
import { Loading, ErrorState, EmptyState, useToast } from './_shared.jsx'
...
export default function IngestEndpoints() {
  ...
  return (
    <Panel className="u-mt-16" title={<span className="ptitle"><Icon name="link" size={16} /> Endpoints de ingesta</span>}
      subtitle="Cómo cada dispositivo envía sus eventos a EventOS (webhook + token). Copiá la URL y pegala en la config de red del equipo.">
      <div className="recep">
        ...
        {presentTypes.length > 0 && (
          <div className="recep-guides u-mt-12">
            {presentTypes.map((t) => {
        ...
        <div className="recep-devhead u-mt-14">
          <span className="section-label"><Icon name="device" size={14} /> URL por dispositivo</span>
          {devices.length > 6 && (
